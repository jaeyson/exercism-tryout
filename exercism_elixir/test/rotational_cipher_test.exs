defmodule RotationalCipherTest do
  ...
  test "rotate a by 1" do
    plaintext = "a"
    shift = 1
    assert rotate(plaintext, shift) == "b"
  end

  test "rotate a by 26, same output as input" do
    plaintext = "a"
    shift = 26
    assert rotate(plaintext, shift) == "a"
  end
  ...
  test "rotate m by 13" do
    plaintext = "m"
    shift = 13
    assert rotate(plaintext, shift) == "z"
  end
  ...
  test "rotate capital letters" do
    plaintext = "OMG"
    shift = 5
    assert rotate(plaintext, shift) == "TRL"
  end

  test "rotate spaces" do
    plaintext = "O M G"
    shift = 5
    assert rotate(plaintext, shift) == "T R L"
  end

  test "rotate numbers" do
    plaintext = "Testing 1 2 3 testing"
    shift = 4
    assert rotate(plaintext, shift) == "Xiwxmrk 1 2 3 xiwxmrk"
  end

  test "rotate punctuation" do
    plaintext = "Let's eat, Grandma!"
    shift = 21
    assert rotate(plaintext, shift) == "Gzo'n zvo, Bmviyhv!"
  end
  ...
  test "rotate all letters" do
    ...
    assert rotate(plaintext, shift) == "Gur dhvpx oebja sbk whzcf bire gur ynml qbt."
  end
end
